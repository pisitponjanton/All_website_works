    ...
    <div className="w-full h-[1000px] relative">
      ...
      <div className="relative top-[170px] z-[1]" ref={elementRef}>
        <div className="relative w-[1290px] h-[700px] bg-bg1-2 bg-cover bg-center bg-no-repeat">
          ...
          <div className={`absolute top-[155px] left-[130px] bg-seed bg-cover bg-center bg-no-repeat w-[120px] h-[120px] ${isVisible ? "scale-1 animate-move-up": "scale-0"}`}></div>
          <div className={`absolute top-[360px] left-[130px] bg-human bg-cover bg-center bg-no-repeat w-[110px] h-[110px] duration-700 ease-in-out ${isVisible ? "scale-1 animate-humann": "scale-0"}`}></div>
